...
\usepackage{booktabs}
\usepackage{nicefrac}
\RequirePackage[noend]{algorithmic} % ADDED TO THIS LINE
...
\end{abstract}
%
\begin{wrapfigure}[21]{r}{0.465\textwidth}
%\centering
...
\begin{algorithm}[H]
\begin{algorithmic}
	\captionof{algorithm}{Simplified joint training of hypernetwork and hyperparameters\label{algMin}}
...
%
\begin{wrapfigure}[38]{r}{0.45\textwidth}
...
\begin{wrapfigure}[32]{r}{0.55\textwidth}
	%\centering
...
%We thank Matthew MacKay, Paul Vicol, Dougal Maclaurin, Daniel Flam-Shepard, Daniel Roy, and Jack Klys for helpful discussions.
